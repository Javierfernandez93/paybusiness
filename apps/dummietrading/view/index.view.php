                ...
                <div class="col-12">
                    <div class="row mb-3">
                        ...
                        <div class="col-6 col-md-3 col-xl-2">
                            <div class="card rounded-xs zoom card-special" style="background-image: url('../../src/img/Unlimited-home/1.png')">
                        ...
                        <div class="col-6 col-md-3 col-xl-2">
                            <div class="card rounded-xs zoom card-special" style="background-image: url('../../src/img/Unlimited-home/2.png')">
                ...
                <div class="col-12">
                    <div class="row mb-3 justify-content-center">
                        <div class="col-6 col-md-4 mb-3 mb-xl-4 col-xl">
                            <div class="card rounded-xs zoom card-special" style="background-image: url('../../src/img/Unlimited-home/3.png')">
                                
                            </div>
                        </div>
                        <div class="col-6 col-md-3 mb-3 mb-xl-4 col-xl">
                            <div class="card rounded-xs zoom card-special" style="background-image: url('../../src/img/Unlimited-home/4.png')">
                                
                            </div>
                        </div>
                        <div class="col-6 col-md-3 mb-3 mb-xl-4 col-xl">
                            <div class="card rounded-xs zoom card-special" style="background-image: url('../../src/img/Unlimited-home/5.png')">
                                
                            </div>
                        </div>
                        <div class="col-6 col-md-3 mb-3 mb-xl-4 col-xl">
                            <div class="card rounded-xs zoom card-special" style="background-image: url('../../src/img/Unlimited-home/6.png')">
