                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-4">
                            ...
                            <select 
                                :class="notice.catalog_notice_id ? 'is-valid' : ''"
                                class="form-select" v-model="notice.catalog_notice_id" aria-label="Selecciona tu país">
                        ...
                        <div class="col-4">
                            ...
                            <select 
                                :class="notice.catalog_priority_id ? 'is-valid' : ''"
                                class="form-select" v-model="notice.catalog_priority_id" aria-label="Selecciona tu país">
                                <option>Selecciona una categoría</option>
                    ...
                    <button 
                        :disabled="!noticeComplete"
                        ref="button"
                        class="btn btn-primary" @click="saveNotice">Guardar</button>
                </div>
            </div>
        </div>
        <div class="col-4">
