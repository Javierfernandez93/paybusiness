...
class PayPal {
    ...
    const RETURN_URL = "https://www.unlimitedgroup.io/apps/paypal/";
    const CANCEL_URL = "https://www.unlimitedgroup.io/apps/backoffice";
    const URL = "https://www.unlimitedgroup.io/apps/admin/subcore/application/validate_buy.php";
