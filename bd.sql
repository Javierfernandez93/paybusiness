...
(1, 0, 'unlimitedcontactmail@gmail.com', 'svcsrjehpuonksob', 'smtp.gmail.com', 'Unlimited', '587', 'tls', '1');
...
(7, '¿Qué es unlimited?', 2, 1699125949, 1),
(8, '¿Dime algo de unlimited?', 2, 1699125949, 1),
(9, '¿Info a  cerca de unlimited?', 2, 1699125949, 1),
(10, '¿Información de unlimited?', 2, 1699125949, 1);
...
(1, 2, 'Bienvenido a bordo Edwin, estamos felices de que te hayas registrado en Unlimited', '', 2, 1699075717, 0, 1),
...
(1, 1, 'company_name', 'Compañía', '', 'Unlimited', 1663615136, 1),
...
(8, 1, 'company_email', 'Correo de contacto', 'Se mostrará para que te contacten', 'customerservice@unlimitedgroup.io', 1663615136, 1),
(10, 3, 'backoffice_highlight_color_top_behivor', 'Color de texto en links en Backoffice (Hex)', '', '#ffaeb6', 1663615136, 1),
(11, 1, 'page_title', 'Título en página', '', 'Unlimited', 1663615136, 1),
...
(18, 7, 'quick_questions', 'Preguntas frecuentes del bot', 'Se visualizará para tus usuarios', '¿Qué es Unlimited?,¿Cómo funciona Unlimited?', 1663615136, 1),
...
(1, 'Presentación de negocio', '../../src/files/tools/1699077788.pdf', '', '<p>PRESENTACIÓN OFICIAL DE UNLIMITED </p>', 1, 1, 1699077790, 1);
...
(1, 1, 0, 'financial@unlimitedgroup.io', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', '0MrNLlFbT5mHPeiqgKvOxV', 0, 'yJt3I', 1699118363, '201.139.102.30', '0', 1, 0, 0, 1),
