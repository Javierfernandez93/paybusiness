...
<html lang="es">
    <head>
        ...
        <meta content="Disruptivo | Trading profesional" name="description" />
        ...
        <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/header-sticky.js?v=1.0.6" type="text/javascript"></script>
                      ...
                      <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                          <ul class="navbar-nav ms-auto mb-2 mb-md-0">
                            ...
                            <li class="nav-item px-1">
                              <a class="nav-link btn-danger rounded-pill px-3 btn text-white" href="mailto:contacto@financierasanandres.com?Subject=Necesito información de Disruptivo | Trading profesional" tabindex="-1" aria-disabled="true">Contacto</a>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div class="col-12 col-md-4 col-xl-4 my-5 my-xl-0">
                            <div class="row d-flex justify-content-center">
                                <div class="col-4 col-md-8">
                                    <img src="../../src/img/logo.png?t=1" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4 col-xl-4">
                            <div class="mb-3">
                                ...
                                <a href="mailto:contacto@financierasanandres.com?Subject=Necesito información de Disruptivo | Trading profesional" class="text-white">contacto@financierasanandres.com</a>
