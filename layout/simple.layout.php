...
<head>
    ...
    <meta content="Disruptivo | Trading profesional" name="author" />
    ...
    <meta property="og:site_name" content="Disruptivo | Trading profesional">
    <meta property="og:title" content="Disruptivo | Trading profesional" />
    <meta property="og:description" content="Herramientas deTrading profesional" />
    <meta property="og:image" itemprop="image" content="https://www.Disruptivogroup.io/src/img/logo.png">
    ...
    <meta property="og:url" content="http://www.Disruptivogroup.io">
...
<body>
    ...
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/general.js?v=1.0.0" type="text/javascript"></script>
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/constants.js?v=1.0.0" type="text/javascript"></script>
