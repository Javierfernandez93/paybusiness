...
<body>
    ...
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/general.js?v=1.0.5" type="text/javascript"></script>
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/constants.js?v=1.0.5" type="text/javascript"></script>
