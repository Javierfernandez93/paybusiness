...
<body data-sidebar="dark">
    ...
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/jquery-3.1.1.js" type="text/javascript"></script>
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/jquery-ui.js?v=2.5.0" type="text/javascript"></script>
    ...
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/boxloader.js?v=2.5.0" type="text/javascript"></script>
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/http.js?v=2.5.0" type="text/javascript"></script>
