...
<body class="g-sidenav-show bg-light mt-3">
    ...
    <script src="../../src/js/general.js?v=2.3.5" type="text/javascript"></script>
    <!-- Github buttons -->
    ...
    <script src="../../src/js/soft-ui-dashboard.min.js?v=2.3.5"></script>
    ...
    <script src="../../src/js/translateInit.vue.js?v=2.3.5" type="module"></script> -->
    
    {{js_scripts}}
    {{css_scripts}}

    <!-- <script src="../../src/js/translate.js?v=2.3.5" type="text/javascript"></script> -->
</body>
</html>