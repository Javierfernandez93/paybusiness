...
<body class="g-sidenav-show bg-light mt-3">
    ...
    <script src="../../src/js/constants.js?v=1.1.4" type="text/javascript"></script>
    ...
    <script src="../../src/js/top.vue.js?v=1.1.4" type="module"></script>
    <script src="../../src/js/notice.vue.js?v=1.1.4" type="module"></script>
    <script src="../../src/js/chat.vue.js?v=1.1.4" type="module"></script>
    <!-- <script src="../../src/js/translate.module.js?v=1.1.4" type="module"></script>
    
    <script src="../../src/js/translateInit.vue.js?v=1.1.4" type="module"></script> -->
    
    {{js_scripts}}
    {{css_scripts}}

    <!-- <script src="../../src/js/translate.js?v=1.1.4" type="text/javascript"></script> -->
</body>
</html>