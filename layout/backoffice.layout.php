...
<body class="g-sidenav-show bg-light">
    ...
    <script src="../../src/js/general.js?v=2.3.4" type="text/javascript"></script>
    <!-- Github buttons -->
    ...
    <script src="../../src/js/vue.js?v=2.3.4" type="text/javascript"></script>
    <script src="../../src/js/top.vue.js?v=2.3.4" type="module"></script>
    <script src="../../src/js/chat.vue.js?v=2.3.4" type="module"></script>
    <!-- <script src="../../src/js/translate.module.js?v=2.3.4" type="module"></script>
    
    <script src="../../src/js/translateInit.vue.js?v=2.3.4" type="module"></script> -->
    
    {{js_scripts}}
    {{css_scripts}}

    <!-- <script src="../../src/js/translate.js?v=2.3.4" type="text/javascript"></script> -->
</body>
</html>