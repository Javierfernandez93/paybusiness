...
<html lang="es">
  <head>
    ...
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/ruler.js?v=1.0.7" type="text/javascript"></script>
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/general.js?v=1.0.7" type="text/javascript"></script>
