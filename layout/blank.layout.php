...
<html lang="es">
  <head>
    ...
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/ruler.js?v=1.1.1" type="text/javascript"></script>
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/general.js?v=1.1.1" type="text/javascript"></script>
