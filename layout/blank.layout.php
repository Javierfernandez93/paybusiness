...
<html lang="es">
  <head>
    ...
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/ruler.js?v=2.4.2" type="text/javascript"></script>
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/general.js?v=2.4.2" type="text/javascript"></script>
