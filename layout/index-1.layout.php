...
<body>
            ...
            <div class="topbar topbar-1 bg-black">
                <div class="container">
                    <div class="block-left">
                        <p class="text-block">Somos expertos en marketing digital, llevaremos tus sueños a la realidad</p>
                    </div>
    ...
    <div class="section d-none bg-parallax p-t-120 p-b-120" style="background: url(../../template/images/banner-01.jpg) no-repeat;" data-paroller-type="background" data-paroller-factor="-0.3" data-paroller-direction="vertical">
        ...
        <div class="container">
            <p class="text-block text-white text-center p-l-100 p-r-100 relative text-lead">Somos expertos en marketing digital, llevaremos tus sueños a la realidad</p>
        </div>
    </div>
    <!-- section / end-->
    <!-- Latest News / start-->
