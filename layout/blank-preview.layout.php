...
<html lang="es">
  ...
  <body>
    ...
    <div class="position-fixed w-100 bg-light bottom-0">
      <div class="row p-3">
        <div class="col">
          <div class="small fw-semibold"><t>VCard</t></div>
        </div>
        <div class="col-auto">
          <div class="badge badge-light"><t>Vista previa</t></div>
        </div>
      </div>
    </div>
    ...
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/constants.js?v=2.6.4" type="text/javascript"></script>
    ...
    <script src="<?php echo HCStudio\Connection::getMainPath();?>/src/js/general.js?v=2.6.4" type="text/javascript"></script>
