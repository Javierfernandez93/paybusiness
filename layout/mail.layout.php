...
<head>
    ...
    <style id="" media="all">
        ...
        @font-face {
            ...
            font-weight: 200;
            font-display: swap;
            src: url(/fonts.gstatic.com/s/worksans/v18/QGYsz_wNahGAdqQ43Rh_c6DptfpA4cD3.woff2) format('woff2');
        ...
        @font-face {
            ...
            font-weight: 200;
            font-display: swap;
            src: url(/fonts.gstatic.com/s/worksans/v18/QGYsz_wNahGAdqQ43Rh_cqDptfpA4cD3.woff2) format('woff2');
        ...
        @font-face {
            ...
            font-weight: 200;
            font-display: swap;
            src: url(/fonts.gstatic.com/s/worksans/v18/QGYsz_wNahGAdqQ43Rh_fKDptfpA4Q.woff2) format('woff2');
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PLRSX34"
