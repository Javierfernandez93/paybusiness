...
if(!validateCronCredentials() && !$UserSupport->logged) {
    endWebServiceWithUnauthorized(Constants::RESPONSES['INVALID_CREDENTIALS'],printErrorFromCronjob(),true);
}
...
function send(array $data = null,$BuyPerUser = null,$Wallet = null)
{
...
endWebServiceWithSuccess(Constants::RESPONSES['CRONJOB_EJECUTED'],[
    'dispertions' => $dispertions,
    'code' => 'gains',
    'mode' => $UserSupport->logged ? 'user' : 'cron'
],true);