...
function createTransaction(Site\BuyPerUser $BuyPerUser = null,Site\UserLogin $UserLogin = null)
{
	...
	} else if($BuyPerUser->catalog_payment_method_id == Site\CatalogPaymentMethod::EWALLET_PROTECTED) {
...
function createTransactionFromEwalletProtected(Site\BuyPerUser $BuyPerUser = null,Site\UserLogin $UserLogin = null)
{
	return [
		'amount' => $BuyPerUser->amount,
		'txn_id' => $BuyPerUser->invoice_id,
