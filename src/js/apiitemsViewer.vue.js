...
const ApiitemsViewer = {
    ...
    methods: {
        ...
        getHtmlPlugin(url,encode) {
            const html = `
                <a href="${url}" target="_blank"><img src="https://www.Disruptivogroup.io/src/img/buy-now.svg" alt="Disruptivo Quick payments" style="width:10rem;"></a>
            `
                                    ...
                                    <li class="list-group-item">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-xl-2">
                                                <a href="`+item.short_url.url+`" target="_blank"><img src="https://www.Disruptivogroup.io/src/img/buy-now.svg" alt="Disruptivo Quick payments" style="width:10rem;"></a>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
