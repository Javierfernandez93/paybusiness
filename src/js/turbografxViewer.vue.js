...
const TurbografxViewer = {
    name : 'turbografx-viewer',
    data() {
        return {
            User: new User,
            ewallet: null,
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        ...
                        <p>Lista de 291 juegos de TurboGraFx</p>
                        <span class="badge bg-secondary">Peso apróximado 64mb</span>
                    </div>
                    <div class="col-auto">
                        <div class="d-grid"> 
                            <a href="https://zuum.link/GamesTurboGrafFx" download class="btn btn-primary shadow-none">Descargar</a>
                        </div>
                        <div class="d-grid"> 
                            <button @click="sendForWhatsApp('Descarga los Juegos de TurboGraFx','https://zuum.link/GamesTurboGrafFx')" class="btn btn-success mb-0 shadow-none">Envíar por WhatsApp</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        ...
                        <p>De la Consola N64 de Disruptivo</p>
                    </div>
                    <div class="col-auto">
                        <div class="d-grid"> 
