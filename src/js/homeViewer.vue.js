                ...
                <div class="col-12 col-xl-9 text-center">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-xl-auto text-start text-white">
                                    <div>
                                        <img src="../../src/img/Unlimited-academy-white.png" alt="Unlimited academy" title="Unlimited academy" />
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-xl-6 text-start text-white">
                                    <div class="mb-3">
                                        <img src="../../src/img/Unlimited-synthetics.png" alt="Unlimited synthetics" title="Unlimited synthetics" />
                                    </div>
                    ...
                    <div class="card mb-3 bg-primary shadow-none" id="card-mentory">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-xl-6 text-start text-white">
                                    <div class="mb-3">
                                        <img src="../../src/img/Unlimited-mentory.png" alt="Unlimited mentory" title="Unlimited mentory" />
                                    </div>
                    ...
                    <div class="row mb-3 align-items-center">
                        <div class="col-12 col-md-6 col-xl-6">
                            <div class="card shadow-none">
                                <img src="../../src/img/card-6.png" alt="Unlimited marketing image" alt="Unlimited marketing image" class="img-fluid"/> 
                            </div>
                        </div>
                        <div class="col-12 col-md-6 col-xl-6 text-start p-5">
                            <img src="../../src/img/Unlimited-marketing.png" alt="brigde funds" title="brigde funds" />
                            <div class="mb-5 mt-3">
