...
const Landing3Viewer = {
    ...
    template : `
            ...
            <div class="container">
                <header class="d-flex flex-wrap justify-content-center py-3 align-items-center">
                    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                        ...
                        <span class="fs-4">
                            <img src="https://www.Disruptivogroup.io/src/img/logo-horizontal-white.svg" width="202" alt="logo">
                        </span>
                    </a>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="d-flex justify-content-center mt-3 fs-3 text-center text-white fst-italic">
                                "Disruptivo es la plataforma online que está ayudando a miles de personas a educarse en negocios, marketing y empredimiento" - RCN radio.
                            </div>
                            <div class="d-flex justify-content-center mt-3">
                ...
                <div class="container text-white text-center">
                    ...
                    <div class="row align-items-center justify-content-center" data-entrance="from-right">
                        <div class="col-9 col-xl-10">
                            <div class="pb-3 mb-3">
                                <img src="https://www.Disruptivogroup.io/src/img/landing2/macebook.png" alt="pc" class="img-fluid">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-7">
                            <div class="row justify-content-center">
                                <div class="col-12 col-xl-10">
                                    <img src="https://www.Disruptivogroup.io/src/img/landing2/phones.png" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row align-items-center pb-5">
                        <div class="col-xl-12 text-white text-center">
                            ...
                            <div class="display-3">PARA UNIRTE A <span class="text-warning">Disruptivo</span></div>
                        </div>
                    </div>
                    <div class="row align-items-center">
                        <div class="col-xl-7" data-entrance="from-right">
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    <img src="https://www.Disruptivogroup.io/src/img/landing2/computer.png" class="w-100">
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5">
                        ...
                        <div class="col-xl-5">
                            <div class="row justify-content-center">
                                <div class="col-5 col-xl-9">
                                    <img src="https://www.Disruptivogroup.io/src/img/landing2/phone-telegram.png" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-7">
        ...
        <footer class="bg-dark row text-center text-white py-3">
            <div class="col">
                <div>Disruptivo powered by <a href="https://www.mizuum.com">Zuum</a> 2023® All rights reserved</div>
            </div>
        </footer>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer border-0">
                        <button @click="doSignup" type="button" class="btn btn-warning text-white btn-lg w-100 fs-4" data-bs-dismiss="modal">UNIRME A Disruptivo</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content bg-dark">
                    ...
                    <div class="modal-body">
                        <div class="card-body" v-if="showing">
                            <div class="row justify-content-center">
                               <div class="col-12">
                                    <img src="https://www.Disruptivogroup.io/src/img/logo-horizontal-white-letters.png" alt="logo" class="img-fluid">
                                </div>
                            </div>
