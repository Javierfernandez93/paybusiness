import { Guest } from '../../src/js/guest.module.js?v=1.1.9'   
    ...
    template : `
        <div class="container" id="main">
            ...
            <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                ...
                <span class="fs-4">
                    <img src="https://www.Disruptivogroup.io/src/img/logo-horizontal-dark-letters.svg" width="222px" alt="logo">
                </span>
            </a>

            <ul class="nav nav-pills">
                <li class="nav-item"><a href="#" class="nav-link active" aria-current="page">INICIO</a></li>
                <li class="nav-item"><a href="https://www.Disruptivogroup.io/apps/login" class="nav-link">Iniciar sesión</a></li>
            </ul>
            </header>
        </div>

        <section class="section-1 cover position-relative" style="background-image: url('https://www.Disruptivogroup.io/src/img/landing-1.jpg')">
        ...
        <section class="section-2 py-5 bg-white">
            <div class="row align-items-center py-5 px-5 px-md-0">
                <div class="container text-center">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="fw-semibold text-dark fs-2">¿Qué es Disruptivo?</div>
                        </div>
                    </div>
                    <div class="row py-5">
                        <div class="col-xl-4">
                            <div class="fw-semibold text-dark fs-4">Nuestra misión</div>    
                            <img src="https://www.Disruptivogroup.io/src/img/landing-1-section-0-1.jpg" class="img-fluid" alt="imagen1">
                        ...
                        <div class="col-xl-4">
                            ...
                            <img src="https://www.Disruptivogroup.io/src/img/landing-1-section-0-2.jpg" class="img-fluid" alt="imagen2">
                        ...
                        <div class="col-xl-4">
                            ...
                            <img src="https://www.Disruptivogroup.io/src/img/landing-1-section-0-3.jpg" class="img-fluid" alt="imagen3">
            ...
            <div class="row align-items-center py-5 px-5 px-md-0">
                <div class="container">
                    <div class="row text-center">
                        <div class="col-xl-12">
                            <div class="fw-semibold text-white text-decoration-underline fs-1">¿Para quién es Disruptivo?</div>
                        </div>
                    </div>
                    <div class="row py-5">
                        <div class="col-xl-4">
        ...
        <section class="section-2 bg-white py-5">
            <div class="row align-items-center py-5 px-5 px-md-0">
                <div class="container">
                    <div class="row text-center">
                        <div class="col-xl-12">
                            <div class="fw-semibold fs-1">¿Qué te ofrece Disruptivo?</div>
                        </div>
                    </div>
                    <div class="row py-5">
                        <div class="col-xl-6 text-center border-right">
                            ...
                            <div class="row mb-3 align-items-center">
                                <div class="col-12">
                                    <img src="https://www.Disruptivogroup.io/src/img/landing-1-section-1-1.jpg" class="img-fluid" style="height:22rem" alt="imagen4">
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                <div class="col-12 col-xl-10">
                        ...
                        <div class="col-xl-6 text-center">
                            ...
                            <div class="row mb-3 align-items-center">
                                <div class="col-12">
                                    <img src="https://www.Disruptivogroup.io/src/img/landing-1-section-1-2.jpg" class="img-fluid" style="height:22rem" alt="imagen5">
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                <div class="col-12 col-xl-10">
        ...
        <div v-if="user.referral.phone" class="position-fixed top-50 end-0 translate-middle-y pe-4" style="z-index:10">
            <div class="mb-3">
                <a :href="user.referral.phone.getWhatsAppFromText('¡Hola! me gustaría tener más información de Disruptivo')" target="_blank" class="btn btn-success rounded-circle shadow-lg">
