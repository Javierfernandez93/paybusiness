        ...
        <div class="row align-items-top">
            <div class="col-12 col-xl-6">
                <div class="row justify-content-start">
                    <div class="col-12">
                        <img src="../../src/img/Disruptivo-academy.png" alt="Academy" title="Academy" class="w-100"/>
                    </div>
                </div>
            ...
            <div class="col-12 col-xl-6">
                ...
                <div class="my-3 text-center">
                    <p class="lead fw-semibold text-dark">Únete al canal de Disruptivo Academy y accede a clases en vivo y operativa de Índices sintéticos.</p>

                    <div class="d-grid">
                        <button class="btn btn-primary btn-lg shadow-none mb-3"><i class="bi me-2 bi-telegram"></i>Unirse al canal</button>
                    </div>

                    <p class="lead fw-semibold text-dark">Únete al canal de Disruptivo y disfruta de las predicciones del mercado de nuestros mentores.</p>
                    <div class="d-grid">
