...
const EditcourseViewer = {
    name : 'editcourse-viewer',
    ...
    methods: {
        ...
        initEditor()
        {
            ...
            this.course.description = this.editor.root.innerHTML = this.course.description
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <input  name="basic" ref="tag" id="tag" :value="course.tag" data-tagify="true">
                                </div>
                            </div>
                        </div>
