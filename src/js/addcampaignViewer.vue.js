...
const AddcampaignViewer = {
    name : 'addcampaign-viewer',
    props : ['viewcountries'],
    ...
    methods: {
        ...
        saveCampaign: function () {
            this.User.saveCampaign(this.campaign, (response) => {
                if (response.s == 1) {
                    this.$refs.save.innerText = '¡Campaña guardada!'
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <button 
                            ...
                            ref="save"
                            @click="saveCampaign" class="btn btn-success m-0">Guardar campaña</button>
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-12 col-xl-6 form-floating mb-3">
                        ...
                        <label for="floatingInput">Nombre de campaña</label>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col">
                        <div v-if="campaign.countries.length > 0">
