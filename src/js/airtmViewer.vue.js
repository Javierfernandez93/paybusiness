                ...
                <div v-if="invoice.status == STATUS.PENDING"
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-light text-center fw-semibold">
                            <strong>¿Quieres saber como realizar el pago?</strong> ve el tutorial de como realizar el pago <a class="text-decoration-underline text-primary" href="https://www.disruptivo.academy/apps/ticket/?fid=10" target="_blank">aquí</a>
                        </div>
                    </div>
                </div>
