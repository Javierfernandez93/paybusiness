...
const MamgainsViewer = {
    ...
    mounted() {
        this.getCommissionPerUserByType(`${this.CATALOG_COMMISSION_TYPE_ID.NETWORK_MAM},${this.CATALOG_COMMISSION_TYPE_ID.FUND_MAM}`).then((response)=>{
    ...
    template : `
        ...
        <div v-else-if="commissions == false" class="row justify-content-center">
            <div class="col-11 col-xl-4">
                <div class="card rounded-normal card-message-main text-center" style="background-image:url(../../src/img/marketing-banner.png)">
                    <div class="card-body card-message d-flex align-items-center rounded-normal text-center">
                        <div class="row w-100 text-center">
                            <div class="col-12">
                                <div class="text-start">
                                    <img src="../../src/img/logo-evox-marketing.png" class="img-fluid mb-3" alt="academy" title="academy"/>
