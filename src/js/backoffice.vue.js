...
import { MapViewer } from '../../src/js/mapViewer.vue.js?v=2.3.3'   
import { DailyViewer } from '../../src/js/dailyViewer.vue.js?v=2.3.3'   
import { IncomeViewer } from '../../src/js/incomeViewer.vue.js?v=2.3.3'   
import { TeamselectorViewer } from '../../src/js/teamselectorViewer.vue.js?v=2.3.3'   
